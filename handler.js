...
export async function handler(chatUpdate) {
	...
	await this.readMessages([m.key])
        ...
        if (!m.fromMem && m.text.match(/(𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ|@5214445888181|@595984101796|bot|FranBot|FranStanleyBot|BotFranStanley|StanleyBot)/gi)) {
