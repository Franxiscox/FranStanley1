...
if (user.joincount < 1) throw `${ag}*¡𝒀𝒂 𝒏𝒐 𝒕𝒊𝒆𝒏𝒆 𝒕𝒐𝒌𝒆𝒏𝒔! 🪙*\n\n*𝑪𝒐𝒎𝒑𝒓𝒂 𝒕𝒐𝒌𝒆𝒏𝒔 𝒑𝒂𝒓𝒂 𝒑𝒐𝒅𝒆𝒓 𝒊𝒏𝒗𝒊𝒕𝒂𝒓 𝒂 𝑻𝒉𝒆 𝑳𝒐𝒍𝒊𝒃𝒐𝒕-𝑴𝑫 𝒂 𝒕𝒖 𝒈𝒓𝒖𝒑𝒐 𝒄𝒐𝒏 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 ${usedPrefix}buy3 o ${usedPrefix}buyall3* *𝑪𝒂𝒏𝒕𝒊𝒅𝒂𝒅*`
 ...
 if (args[1] < 3) throw `${fg}*𝑴𝒂́𝒙𝒊𝒎𝒐 3 𝒕𝒐𝒌𝒆𝒎(S) 𝒑𝒂𝒓𝒂 𝒑𝒐𝒅𝒆𝒓 𝒊𝒏𝒗𝒊𝒕𝒂𝒓 𝒂 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ`
 if (args[1] > 3) throw `${fg}*𝑴𝒊́𝒏𝒊𝒎𝒐 3 𝒕𝒐𝒌𝒆𝒏(S) 𝑷𝒂𝒓𝒂 𝒑𝒐𝒅𝒆𝒓 𝒊𝒏𝒗𝒊𝒕𝒂𝒓 𝒂 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ*` //Solo ingresará si tiene 3 Token(s)
 
let res = await conn.groupAcceptInvite(code) 
conn.reply(m.chat, `${eg}😛 𝑺𝒆 𝒉𝒂 𝒖𝒏𝒊𝒅𝒐 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ 𝒂𝒍 𝒈𝒓𝒖𝒑𝒐!!!*`, m).then(async() => { 
...
await conn.reply(m.chat, `${wm} *𝑬𝒔 𝒖𝒏 𝒃𝒐𝒕 𝒅𝒆 𝑾𝒉𝒂𝒕𝒔𝑨𝒑𝒑 𝒒𝒖𝒆 𝒕𝒆 𝒂𝒚𝒖𝒅𝒂𝒓𝒂́ 𝒂 𝒓𝒆𝒂𝒍𝒊𝒛𝒂𝒓 𝒅𝒊𝒇𝒆𝒓𝒆𝒏𝒕𝒆 𝒂𝒄𝒕𝒊𝒗𝒊𝒅𝒂𝒅𝒆𝒔 🪄 𝑨𝒍 𝒑𝒓𝒊𝒗𝒂𝒅𝒐 𝒐 𝒈𝒓𝒖𝒑𝒐 𝒚 𝒕𝒂𝒎𝒃𝒊𝒆́𝒏 𝒕𝒆 𝒗𝒂𝒔 𝒂 𝒅𝒊𝒗𝒆𝒓𝒕𝒊𝒓 🎈  𝑪𝒐𝒏 𝒔𝒖𝒔 𝒎𝒖́𝒍𝒕𝒊𝒑𝒍𝒆𝒔 𝒇𝒖𝒏𝒄𝒊𝒐𝒏𝒆𝒔, 𝑫𝒊𝒔𝒇𝒓𝒖𝒕𝒂 𝒅𝒆 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ!!! 😸*\n\n💖 *𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ 𝒇𝒖𝒆 𝒊𝒏𝒗𝒊𝒕𝒂𝒅𝒐 𝒑𝒐𝒓:*\n${username}`, m)
...
if (user.joincount === 0 ) throw `${ag}*¡𝒀𝒂 𝒏𝒐 𝒕𝒊𝒆𝒏𝒆 𝒕𝒐𝒌𝒆𝒏𝒔! 🪙*\n\n*𝑪𝒐𝒎𝒑𝒓𝒂 𝒕𝒐𝒌𝒆𝒏𝒔 𝒑𝒂𝒓𝒂 𝒑𝒐𝒅𝒆𝒓 𝒊𝒏𝒗𝒊𝒕𝒂𝒓 𝒂 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ 𝒂 𝒕𝒖 𝒈𝒓𝒖𝒑𝒐 𝒄𝒐𝒏 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 ${usedPrefix}buy3* *𝑪𝒂𝒏𝒕𝒊𝒅𝒂𝒅*`
  if (!args[1]) throw `${mg}*𝑼𝒔𝒆 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒄𝒐𝒎𝒐 𝒆𝒔𝒕𝒆 𝒆𝒋𝒆𝒎𝒑𝒍𝒐*\n*${usedPrefix + command} 𝑬𝒏𝒍𝒂𝒄𝒆 𝒏𝒖́𝒎𝒆𝒓𝒐 𝒅𝒆 𝒕𝒐𝒌𝒆𝒎(s)*\n\n*𝑬𝒋𝒆𝒎𝒑𝒍𝒐*\n*${usedPrefix + command} ${nn} 3*\n\n*3 𝑻𝒐𝒌𝒆𝒎 🪙 = 30 𝒎𝒊𝒏𝒖𝒕𝒐𝒔*`
if (!linkRegex.test(args[0])) throw `${fg}𝑬𝒏𝒍𝒂𝒄𝒆 𝒏𝒐 𝒗𝒂́𝒍𝒊𝒅𝒐 .` //Aquí 

  let res = await conn.groupAcceptInvite(code) 
  conn.reply(m.chat, `${eg}😛 𝑺𝒆 𝒉𝒂 𝒖𝒏𝒊𝒅𝒐 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ 𝒂𝒍 𝒈𝒓𝒖𝒑𝒐!!!`, m).then(async() => { //Si el Owner se une al Grupo no habrá temporizador
let img = 'https://i.imgur.com/8fK4h6F.jpg'
