...
await conn.sendHydrated(m.chat, gata, wm, null, md, '𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ', null, null, [
['💵 𝒄𝒐𝒎𝒑𝒓𝒂 𝙓10', '.buy2 10'],
['💸 𝒄𝒐𝒎𝒑𝒓𝒂 𝙓20', '.buy2 20'],
['⚡ 𝒄𝒐𝒎𝒑𝒓𝒂 𝒄𝒐𝒏 𝒆𝒙𝒑𝒆𝒓𝒊𝒆𝒏𝒄𝒊𝒂', '/buy']
    ...
    await conn.sendHydrated(m.chat, `*𝑵𝒐 𝒕𝒊𝒆𝒏𝒆 𝒔𝒖𝒇𝒊𝒄𝒊𝒆𝒏𝒕𝒆 *𝒍𝒐𝒍𝒊𝒄𝒐𝒊𝒏𝒔* 𝒑𝒂𝒓𝒂 𝒄𝒐𝒎𝒑𝒓𝒂𝒓 ${count} 𝒅𝒊𝒂𝒎𝒂𝒏𝒕𝒆* 💎\n\n*𝑳𝒆 𝒓𝒆𝒄𝒐𝒎𝒊𝒆𝒏𝒅𝒐 𝒒𝒖𝒆 𝒊𝒏𝒕𝒆𝒓𝒂𝒄𝒕𝒖́𝒆𝒔 𝒄𝒐𝒏 𝕭𝖔𝖙 𝕱𝖗𝖆𝖓 𝕾𝖙𝖆𝖓𝖑𝖊𝖞ت︎ツ  𝒑𝒂𝒓𝒂 𝒐𝒃𝒕𝒆𝒏𝒆𝒓 𝒍𝒐𝒍𝒊𝒄𝒐𝒊𝒏𝒔, 𝒑𝒖𝒆𝒅𝒆 𝒗𝒆𝒛 𝒔𝒖 𝒍𝒐𝒍𝒊𝒄𝒐𝒊𝒏𝒔 𝒄𝒐𝒏 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 ${usedPrefix}lolicoins o ${usedPrefix}experiencia. 𝑻𝒂𝒎𝒃𝒊𝒆́𝒏 𝒑𝒖𝒆𝒅𝒆 𝒄𝒐𝒎𝒑𝒓𝒂𝒓 𝒄𝒐𝒏 𝒔𝒖 𝒆𝒙𝒑𝒆𝒓𝒊𝒆𝒏𝒄𝒊𝒂 𝒄𝒐𝒏 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 ${usedPrefix}buy*`, wm, null, ig, '𝙄𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢', null, null, [
['🐈 𝒄𝒐𝒎𝒑𝒓𝒂 𝒄𝒐𝒏 𝒆𝒙𝒑𝒆𝒓𝒊𝒆𝒏𝒄𝒊𝒂', '/buy'],
